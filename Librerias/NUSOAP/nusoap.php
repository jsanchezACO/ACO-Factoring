...
//		}
	...
	* @access   public
	*/
	function send($data, $timeout=0, $response_timeout=400, $cookies=NULL) {
...
class nusoap_client extends nusoap_base  {
	...
	var $response_timeout = 400;		// HTTP response timeout
	...
	* @access   public
	*/
	function nusoap_client($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 400, $portName = ''){
		parent::nusoap_base();
	...
	* @access   private
	*/
	function send($msg, $soapaction = '', $timeout=0, $response_timeout=400) {
		$this->checkCookies();
		// detect transport
		switch(true){
			// http(s)
